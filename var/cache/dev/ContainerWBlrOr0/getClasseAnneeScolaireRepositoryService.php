 ...
 */
class getClasseAnneeScolaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClasseAnneeScolaireRepository' shared autowired service.
     *
     * @return \App\Repository\ClasseAnneeScolaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClasseAnneeScolaireRepository.php';

        return $container->privates['App\\Repository\\ClasseAnneeScolaireRepository'] = new \App\Repository\ClasseAnneeScolaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
