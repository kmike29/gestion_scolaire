 ...
 */
class getPersonnelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PersonnelRepository' shared autowired service.
     *
     * @return \App\Repository\PersonnelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PersonnelRepository.php';

        return $container->privates['App\\Repository\\PersonnelRepository'] = new \App\Repository\PersonnelRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
