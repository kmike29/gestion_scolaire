 ...
 */
class getTrancheHoraireRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrancheHoraireRepository.php';

        return $container->privates['App\\Repository\\TrancheHoraireRepository'] = new \App\Repository\TrancheHoraireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
