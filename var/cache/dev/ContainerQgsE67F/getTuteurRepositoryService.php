 ...
 */
class getTuteurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TuteurRepository' shared autowired service.
     *
     * @return \App\Repository\TuteurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TuteurRepository.php';

        return $container->privates['App\\Repository\\TuteurRepository'] = new \App\Repository\TuteurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
