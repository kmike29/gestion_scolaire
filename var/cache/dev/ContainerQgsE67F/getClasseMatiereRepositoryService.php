 ...
 */
class getClasseMatiereRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClasseMatiereRepository' shared autowired service.
     *
     * @return \App\Repository\ClasseMatiereRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClasseMatiereRepository.php';

        return $container->privates['App\\Repository\\ClasseMatiereRepository'] = new \App\Repository\ClasseMatiereRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
