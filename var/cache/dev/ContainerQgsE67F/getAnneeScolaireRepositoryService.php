 ...
 */
class getAnneeScolaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnneeScolaireRepository' shared autowired service.
     *
     * @return \App\Repository\AnneeScolaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnneeScolaireRepository.php';

        return $container->privates['App\\Repository\\AnneeScolaireRepository'] = new \App\Repository\AnneeScolaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
