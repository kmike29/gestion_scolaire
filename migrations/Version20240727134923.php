 ...
 */
final class Version20240727134923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS
        SELECT
          id,
          eleve_id,
          classe_id,
        ...
        $this->addSql('CREATE TABLE inscription (
          ...
          CONSTRAINT FK_5E90F6D64E47A399 FOREIGN KEY (remise_id) REFERENCES remise (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE
        )');
        $this->addSql('INSERT INTO inscription (
          id, eleve_id, classe_id, remise_id
        )
        SELECT
          id,
          eleve_id,
