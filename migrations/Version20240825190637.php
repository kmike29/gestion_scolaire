 ...
 */
final class Version20240825190637 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__eleve AS SELECT id, classe_actuelle_id, nom, prenoms, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe, date_de_naissance FROM eleve');
        $this->addSql('DROP TABLE eleve');
        $this->addSql('CREATE TABLE eleve (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, classe_actuelle_id INTEGER DEFAULT NULL, nom VARCHAR(100) NOT NULL, prenoms VARCHAR(255) NOT NULL, nationalite VARCHAR(100) NOT NULL, ecole_de_provenance VARCHAR(255) DEFAULT NULL, date_dinscription DATE NOT NULL, matricule VARCHAR(10) NOT NULL, lieu_de_naissance VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, sexe VARCHAR(10) NOT NULL, date_de_naissance DATE DEFAULT NULL, CONSTRAINT FK_ECA105F74A69A5D7 FOREIGN KEY (classe_actuelle_id) REFERENCES classe_annee_scolaire (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO eleve (id, classe_actuelle_id, nom, prenoms, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe, date_de_naissance) SELECT id, classe_actuelle_id, nom, prenoms, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe, date_de_naissance FROM __temp__eleve');
        $this->addSql('DROP TABLE __temp__eleve');
        $this->addSql('CREATE INDEX IDX_ECA105F74A69A5D7 ON eleve (classe_actuelle_id)');
    }
}
