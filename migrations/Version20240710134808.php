 ...
 */
final class Version20240710134808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__eleve AS SELECT id, classe_id, nom, prenoms, date_de_naissance, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe FROM eleve');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE eleve');
        $this->addSql('CREATE TABLE eleve (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, classe_id INTEGER DEFAULT NULL, nom VARCHAR(100) NOT NULL, prenoms VARCHAR(255) NOT NULL, date_de_naissance DATE NOT NULL, nationalite VARCHAR(100) NOT NULL, ecole_de_provenance VARCHAR(255) DEFAULT NULL, date_dinscription DATE NOT NULL, matricule VARCHAR(10) NOT NULL, lieu_de_naissance VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, sexe VARCHAR(10) NOT NULL, CONSTRAINT FK_ECA105F78F5EA509 FOREIGN KEY (classe_id) REFERENCES classe_annee_scolaire (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO eleve (id, classe_id, nom, prenoms, date_de_naissance, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe) SELECT id, classe_actuelle_id, nom, prenoms, date_de_naissance, nationalite, ecole_de_provenance, date_dinscription, matricule, lieu_de_naissance, photo, sexe FROM __temp__eleve');
        $this->addSql('DROP TABLE __temp__eleve');
