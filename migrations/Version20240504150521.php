 ...
 */
final class Version20240504150521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__classe_matiere AS SELECT classe_id, matiere_id, coefficient FROM classe_matiere');
        $this->addSql('DROP TABLE classe_matiere');
        $this->addSql('CREATE TABLE classe_matiere (classe_id INTEGER NOT NULL, matiere_id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, coefficient INTEGER NOT NULL, PRIMARY KEY(code, classe_id, matiere_id), CONSTRAINT FK_EB8D372B8F5EA509 FOREIGN KEY (classe_id) REFERENCES classe (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EB8D372BF46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO classe_matiere (classe_id, matiere_id, coefficient) SELECT classe_id, matiere_id, coefficient FROM __temp__classe_matiere');
